...
## Add the Webhook in Graphqli

Finally, add a webhook in the Graphqli Console using the url that you have build. To create a webhook you have to go to `Settings` in Graphqli Console then `Webhooks` from the left
