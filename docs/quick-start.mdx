...
title: How to build Graphql API
sidebar_label: Build API
---

import data from "./static/data/config.json"

<span>{data.app}</span> is a Cloud based Backend-as-a-Service which helps you build API easily. You can think of it as a firebase alternative.
...
Once you logged in to `Graphqli Console` you will a Project Space like above. You can use this space to switch between your projects or create a new one.
