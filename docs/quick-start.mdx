...
title: Building API for your Content
...
![Graphqli Console](https://cdn.apito.io/media/apito_website/Y97T0H5XM7_apito_console_full_picture.png)
...
Once you logged in to `Graphqli Console` you will a Project Space like below. You can use this space to switch between your projects or create a new one.

![Graphqli Console](https://cdn.apito.io/media/shikho_website_v2_8ma77/ML8SA3HW4U_projects.png)
...
![Graphqli Create a Project](https://cdn.apito.io/media/apito_documentation/NW09WSY56N_Create_Project.png)
...
label and icons. <span>{data.app}</span>  model & field builder is very versatile you can use it to design complex and nested model structure.
...
For now, let’s say, Product has many categories and categories has many products. Wow, as you can see, how easy it is to create entity relations between models in <span>{data.app}</span> .
...
You can also use REST API if you project requires it. Graphqli Generates a Swagger Documentation which is compatible with OpenAPI.
