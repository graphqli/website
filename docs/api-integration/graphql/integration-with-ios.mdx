---
sidebar_label: iOS
title: GraphQL API Integration with iOS Project
---
<head>
...
You don't need to worry about constructing your queries with request body, headers and options, that you might have done with `AFNetworking` or `NWConnection` say.
...
```sh
apollo schema:download --endpoint=https://api.graphqli.com/secured/graphql --header="Authorization: Bearer API_SECRET"
```
...
class NetworkManager {
    ...
    let graphEndpoint = "https://api.graphqli.com/secured/graphql"
...
## Detailed Guide
For an alternate and detailed guide, be sure to check out the official apollo guide [here](https://www.apollographql.com/docs/ios/)
