---
sidebar_label: React
title: GraphQL API Integration with React based Project
---
<head>
...
and lets us execute GraphQL operations. Apollo Client also manages state and allows us cache our data on the client-side.
