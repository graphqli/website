...
Graphqli [AWS Lambda Function](/docs/extensions/logic/enable-lambda-extension) Extension needs Access and Secret Key in-order for your logic function to operate.
You can use your old credential if you have any, but it is recommended to create a new IAM in AWS for graphqli.

### Creating AWS Users for graphqli
