...
<Image img='https://cdn.apito.io/media/apito_documentation/5IZDKXLO9K_Create_A_Model.png' alt='Creating Model' title='Creating Model' />
...
![Modeling Relationship](https://cdn.apito.io/media/apito_documentation/C40KXDXNBH_Apito_Console___Creating_Relations.png)
