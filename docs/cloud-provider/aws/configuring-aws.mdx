...
Apito [AWS Lambda Function](/docs/logic/enable-lambda-extension) Extension needs Access and Secret Key in-order for your logic function to operate. You can use your old credential if you have any,
but it is recommended to create a new IAM in AWS for apito.
...
![Apito Console - User Accounts](https://cdn.apito.io/media/apito_documentation/T4FOR5PY20_Creating_AWS_User_Accounts.png)
