export const HomePageData = {
    seo : {
        ...
        description:'The most powerful Headless CMS for your Content with Team Collaborations, Revision, CDN & Much more',
        keywords: 'api, graphql, rest api, cms headless, cms for website, api integration, free cms, free api, api development, free headless cms, develop an api, api roles, auth api, graphql explorer, multilingual cms, api in cloud'
    },
    header : {
        ...
        data: [
            {
                ...
                "description": {
                    "markdown": "Content Modeling has never been easier. Model your database with fields & relations"
                },
                "header": "DATABASE",
                "icon": {
...
/*            {
            ...
            },*/
            {
                ...
                "description": {
                    "markdown": "Instantly connectable GraphQL & REST API with Complex Filter"
                },
                "header": "INSTANT API",
                "icon": {
    ...
    features2 : {
        ...
        data: [

            {
                ...
                "description": {
                    "markdown": "Insert, Delete, Update, Draft & Publish your content easily with multilingual support"
                },
                "header": "CMS",
                "icon": {
                    "url": "https://cdn.apito.io/media/apito_website/8XRYHC4LBQ_auth_module.svg"
...
/*            {
            ...
            }*/
            {
                ...
                "description": {
                    "markdown": "Ability to manage api access and content moderation via custom roles & permissions"
                },
        ...
        data: [
            {
                ...
                "description": {
                    "markdown": "Stop worrying about hosting your media files elsewhere. Graphqli also comes with Upload API Support"
                },
                "header": "FILE STORAGE",
                "icon": {
                    "url": "https://cdn.apito.io/media/apito_website/8XRYHC4LBQ_auth_module.svg"
...
/*            {
            ...
            },*/
            {
                ...
                "description": {
                    "markdown": "Invite your Team members and Collaborate on your content publishing with different access roles & permissions"
                },
                "header": "TEAMS",
                "icon": {
                    "url": "https://cdn.apito.io/media/apito_website/8XRYHC4LBQ_auth_module.svg"
